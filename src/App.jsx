...
import { 
    ...
    Zap, Shield, Star, Megaphone, Save, X, Search, Plane, Calculator, DollarSign, Crown, Info, Clock, Tag, ArrowLeft
} from 'lucide-react'; 

import LoginScreen from "./components/LoginScreen";
import WishForm from "./components/WishForm";
import GroupForm from "./components/GroupForm";
import PersonalRequestForm from "./components/PersonalRequestForm";
import OrderForm from "./components/OrderForm";
import OrderSummary from "./components/OrderSummary";
import SecondPaymentForm from "./components/SecondPaymentForm"; 
            ...
            <header className="sticky top-0 z-30 bg-slate-900 border-b-4 border-yellow-400 px-4 py-3 shadow-md">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="bg-yellow-400 p-2 rounded transform -skew-x-12 border-2 border-white"><ShoppingBag size={24} className="text-slate-900 transform skew-x-12" /></div>
